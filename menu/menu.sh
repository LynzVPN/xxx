...
echo -e "${BIBlue} │"
echo -e " ${BIBlue}│  ${BIWhite}SCRIPT BY        :  ${BIWhite}LYNZ TUNNEL${NC}"   
...
echo -e " ${BIBlue}└─────────────────────────────────────────────────────┘${NC}"
echo -e "      ${BIBlue}[${BIWhite}01${BIBlue}]${RED} •${NC} ${BIBlue}SSH MENU        $NC  ${BIBlue}[${BIWhite}09${BIBlue}]${RED} • ${NC}${BIBlue}SPEEDTEST $NC"
echo -e "      ${BIBlue}[${BIWhite}02${BIBlue}]${RED} •${NC} ${BIBlue}VMESS MENU      $NC  ${BIBlue}[${BIWhite}10${BIBlue}]${RED} • ${NC}${BIBlue}SET AUTO REBOOT $NC"
echo -e "      ${BIBlue}[${BIWhite}03${BIBlue}]${RED} •${NC} ${BIBlue}VLESS MENU      $NC  ${BIBlue}[${BIWhite}11${BIBlue}]${RED} • ${NC}${BIBlue}RESTART ALL SERVICE $NC"
echo -e "      ${BIBlue}[${BIWhite}04${BIBlue}]${RED} •${NC} ${BIBlue}TROJAN MENU     $NC  ${BIBlue}[${BIWhite}12${BIBlue}]${RED} • ${NC}${BIBlue}CEK BANDWIDTH $NC"
echo -e "      ${BIBlue}[${BIWhite}05${BIBlue}]${RED} •${NC} ${BIBlue}S-SOCK MENU     $NC  ${BIBlue}[${BIWhite}13${BIBlue}]${RED} • ${NC}${BIBlue}INSTALL UDP SERVICE  $NC"
echo -e "      ${BIBlue}[${BIWhite}06${BIBlue}]${RED} •${NC} ${BIBlue}CEK RUNNING     $NC  ${BIBlue}[${BIWhite}14${BIBlue}]${RED} • ${NC}${BIBlue}CERTV2RAY/ADD SSL $NC"
echo -e "      ${BIBlue}[${BIWhite}07${BIBlue}]${RED} •${NC} ${BIBlue}CLEAR CACHE     $NC  ${BIBlue}[${BIWhite}15${BIBlue}]${RED} • ${NC}${BIBlue}CHANGE BANNER $NC"
echo -e "      ${BIBlue}[${BIWhite}08${BIBlue}]${RED} •${NC} ${BIBlue}MENU DOMAIN     $NC  ${BIBlue}[${BIWhite}16${BIBlue}]${RED} • ${NC}${BIBlue}CHANGE PASSWORD $NC"
echo -e "      ${BIBlue}[${BIWhite}X ${BIBlue}]${RED} •${NC} ${BIBlue}TYPE X FOR EXIT $NC  ${BIBlue}[${BIWhite}17${BIBlue}]${RED} • ${NC}${BIBlue}INSTALL TCP BBR $NC"  
echo -e " ${BIBlue} ┌─────────────────────────────────────────────────────┐${NC}"
